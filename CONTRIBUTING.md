...
Please submit issues related to the *specmake* project through
[Github specmake issues](https://github.com/specthings/specmake/issues).
...
We use the
[Developer Certificate of Origin (DCO)](https://github.com/specthings/specmake/blob/main/DCO.txt)
